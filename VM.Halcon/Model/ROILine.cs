...
namespace VM.Halcon.Model
{
    ...
    public class ROILine : ROI
    {
        ...
        public double _Phi;
        /// <summary>直线弧度</summary>
        public double Phi
        {
            get { return _Phi; }
            set { Set(ref _Phi, value,new Action(() =>
            {
                HTuple hTuple = new HTuple(_Phi);
                _Deg = hTuple.TupleDeg().D;
            })); }
        }
        public double _Deg;
        ...
        public override void Draw(HWindow window)
        {
            ...
            //window.SetDraw("fill");
            window.DispRectangle2(StartY, StartX, 0, m_Size, m_Size);
            window.DispObj(arrowHandleXLD);  //window.DispRectangle2( EndY, EndX, 0, 25, 25);
            window.DispRectangle2(MidX, MidY, 0, m_Size, m_Size);
        ...
        public override void DisplayActive(HWindow window)
        {
            ...
            {
                case 0:
                    window.DispRectangle2(StartY, StartX, 0, MoveRoiSize, MoveRoiSize);
                    break;
                case 1:
                    window.DispObj(arrowHandleXLD); //window.DispRectangle2(EndY, EndX, 0, 25, 25);
                    break;
                case 2:
                    window.DispRectangle2(MidX, MidY, 0, MoveRoiSize, MoveRoiSize);
                    break;
            }
        }
