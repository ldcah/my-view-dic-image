...
namespace VM.Halcon.Model
{
    ...
    public class ROIRectangle1 : ROI
    {
        ...
        public override void Draw(HWindow window)
        {
            ...
            //window.SetDraw("fill");
            window.DispRectangle2(row1, col1, 0, m_Size, m_Size);
            window.DispRectangle2(row1, col2, 0, m_Size, m_Size);
            window.DispRectangle2(row2, col2, 0, m_Size, m_Size);
            window.DispRectangle2(row2, col1, 0, m_Size, m_Size);
            window.DispRectangle2(midR, midC, 0, m_Size, m_Size);
        }
        ...
        public override void DisplayActive(HalconDotNet.HWindow window)
        {
            ...
            {
                case 0:
                    window.DispRectangle2(row1, col1, 0, MoveRoiSize, MoveRoiSize);
                    break;
                case 1:
                    window.DispRectangle2(row1, col2, 0, MoveRoiSize, MoveRoiSize);
                    break;
                case 2:
                    window.DispRectangle2(row2, col2, 0, MoveRoiSize, MoveRoiSize);
                    break;
                case 3:
                    window.DispRectangle2(row2, col1, 0, MoveRoiSize, MoveRoiSize);
                    break;
                case 4:
                    window.DispRectangle2(midR, midC, 0, MoveRoiSize, MoveRoiSize);
                    break;
            }
        }
