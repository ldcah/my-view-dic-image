...
namespace VM.Halcon.Config
{
    ...
    public class HRoi
    {
        ...
        /// <summary>测量roi</summary>
        public HRoi() { }
        public HRoi(int moduleEncode, string moduleName,int roiIndex, string remarks, HRoiType _roiType, string _drawColor, HObject _hobject, bool isFillDisp = false)
        {
    ...
    public class HText : HRoi
    {
        ...
        //多文本显示
        public HText(int _CellID, string _CellType, string _CellNote, int _FlagEncode, string _drawColor, string _text, string _font, double _row, double _col, int _size)
        {
            ModuleEncode = _CellID;
            ModuleName = _CellType;
            Remarks = _CellNote;
            RoiIndex = _FlagEncode;
            drawColor = _drawColor;
            text = _text;
            font = _font;
            row = _row;
